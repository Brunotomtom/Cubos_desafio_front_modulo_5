...
O desafio final do último módulo do curso de formação em desenvolvimento de software da <b>Cubos Academy</b>.

Feito em equipe de 4 pessoas com 2 no front end e 2 no back end, usando metodologia ágil (3 sprints descritas abaixo).

Tecnologias usadas no front end: <b>React, Material UI (MUI), Axios e Figma</b>.
